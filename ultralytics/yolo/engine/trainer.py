...
class BaseTrainer:
    ...
    def __init__(self, cfg=DEFAULT_CFG, overrides=None, _callbacks=None):
        ...
        self.trainset, self.trainset2, self.testset, self.testset2 = self.get_dataset(self.data)  # cys
        self.ema = None
    ...
    def get_dataset(data):
        ...
        """
        return data['train'], data['train2'], data.get('val'), data.get('val2') or data.get('test')  # cys
